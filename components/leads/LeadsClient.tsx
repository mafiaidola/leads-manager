...
import { Search, FileUp, Download, MoreHorizontal, Pencil, Trash2, ChevronLeft, ChevronRight, UserPlus, Filter, Star, CheckSquare, ArrowRightLeft, Undo2 } from "lucide-react";
...
export function LeadsClient({
    leads, total, stats, settings, users, currentUserRole, currentUserId
}: {
    leads: any[], total: number, stats: any[], settings: any, users: any[], currentUserRole: string, currentUserId?: string
}) {
                            ...
                            <Dialog open={isImportOpen} onOpenChange={setIsImportOpen}>
                                ...
                                <DialogContent>
                                    ...
                                    <form onSubmit={handleImport} className="space-y-4">
                                        ...
                                        <Button type="submit" disabled={importing}>{importing ? "Importing..." : "Upload & Import"}</Button>
                                    </form>
                                </DialogContent>
                            </Dialog>
                        </>
