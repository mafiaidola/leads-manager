                        ...
                        <CardContent className="p-0">
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    <div
                                        className="org-logo-swatch h-14 w-14 rounded-2xl flex items-center justify-center shadow-lg text-white font-bold text-xl flex-shrink-0"
                                        style={{ background: `linear-gradient(135deg, ${org.branding?.accentColor || "#8b5cf6"}, ${org.branding?.accentColor || "#8b5cf6"}99)` }}
                                    >
                                        ...
                                        {editSection === "branding" && (
                                            <div className="space-y-4">
                                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                    ...
                                                    <div className="space-y-2">
                                                        ...
                                                        <div className="flex gap-2 items-center">
                                                            <div className="org-color-preview h-10 w-10 rounded-xl border border-white/20 shadow-inner flex-shrink-0" style={{ backgroundColor: brandForm.accentColor }} />
                                                ...
                                                <div className="p-4 bg-white/[0.03] rounded-2xl border border-white/10">
                                                    ...
                                                    <div className="flex items-center gap-3">
                                                        <div className="org-preview-logo h-12 w-12 rounded-xl flex items-center justify-center text-white font-bold text-lg" style={{ background: `linear-gradient(135deg, ${brandForm.accentColor}, ${brandForm.accentColor}99)` }}>
