    ...
    if (!rawStats) return (
        <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4 text-center">
            ...
            <div>
                ...
                <p className="text-sm text-muted-foreground mt-1 max-w-md">There was an issue fetching your dashboard data. This is usually temporary.</p>
            </div>
            <a href="/" className="px-4 py-2 rounded-xl bg-primary/10 hover:bg-primary/20 text-primary text-sm font-semibold transition-colors">
                Try Again
            </a>
        </div>
    );
